<template>
  <Layout>
    ...
    >
      <GImage
        :src="$static.wordPressPage.acf.sectors.image.downloaded"
        :alt="$static.wordPressPage.acf.sectors.image.altText"
        :title="$static.wordPressPage.acf.sectors.image.altText"
      />
      <div class="md:pl-12">
