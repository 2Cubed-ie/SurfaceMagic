<template>
	<Layout>
		<article class="pb-20 -mb-12 content bg-light">
			<div v-if="$page.wordPressPost.featuredMedia" class="w-full -mb-24 bg-center bg-cover h-50vh" :style="{
          backgroundImage: `url(${$page.wordPressPost.featuredMedia.downloaded.src})`,
			...
			<div class="container">
				<div class="z-10 w-full p-2 -mt-12 bg-white shadow-lg md:p-8 mx4">
					...
					<div class="px-8 py-4 m-auto mt-8 font-light prose post-content max-w-none" v-html="$page.wordPressPost.content"></div>
				</div>
			</div>
		</article>
	</Layout>
